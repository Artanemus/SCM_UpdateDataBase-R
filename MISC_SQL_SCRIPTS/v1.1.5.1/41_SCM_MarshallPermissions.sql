...
go
GRANT SELECT ON dbo.EventStatus TO SCM_Marshall
go
GRANT SELECT ON dbo.SessionStatus TO SCM_Marshall
go
...
go
GRANT SELECT ON dbo.HeatType TO SCM_Marshall
go
...
go
GRANT SELECT ON dbo.Stroke TO SCM_Marshall
go
GRANT SELECT ON dbo.Distance TO SCM_Marshall
go
GRANT SELECT ON dbo.EventType TO SCM_Marshall
go
GRANT DELETE ON dbo.HeatTeam TO SCM_Marshall
go
GRANT INSERT ON dbo.HeatTeam TO SCM_Marshall
go
GRANT SELECT ON dbo.HeatTeam TO SCM_Marshall
go
GRANT UPDATE ON dbo.HeatTeam TO SCM_Marshall
go
...
go
GRANT SELECT ON dbo.Gender TO SCM_Marshall
go
...
go
GRANT SELECT ON dbo.ContactNumType TO SCM_Marshall
go
...
go
GRANT SELECT ON dbo.SCMSystem TO SCM_Marshall
go
...
go
GRANT EXECUTE ON dbo.SwimmerGenderToString TO SCM_Marshall
go
GRANT EXECUTE ON dbo.SwimTimeToString TO SCM_Marshall
go
GRANT EXECUTE ON dbo.TimeToBeat_1 TO SCM_Marshall
go
GRANT EXECUTE ON dbo.TimeToBeat_2 TO SCM_Marshall
go
GRANT EXECUTE ON dbo.TimeToBeat TO SCM_Marshall
go
GRANT EXECUTE ON dbo.PersonalBest TO SCM_Marshall
go
GRANT EXECUTE ON dbo.SwimTimeToMilliseconds TO SCM_Marshall
go
GRANT EXECUTE ON dbo.EntrantCount TO SCM_Marshall
go
GRANT EXECUTE ON dbo.NomineeCount TO SCM_Marshall
go
GRANT EXECUTE ON dbo.HeatCount TO SCM_Marshall
go
GRANT EXECUTE ON dbo.SessionEntrantCount TO SCM_Marshall
go
GRANT EXECUTE ON dbo.SessionNomineeCount TO SCM_Marshall
go
GRANT EXECUTE ON dbo.IsPoolShortCourse TO SCM_Marshall
go
GRANT EXECUTE ON dbo.ABSHeatPlace TO SCM_Marshall
go
GRANT EXECUTE ON dbo.RELEventPlace TO SCM_Marshall
go
